...
public class DataManager {
    ...
    /*next we have a public static final string for each row/table that we
    * need to refer to both inside and outside this class*/
    ...
    * that we need to refer to just inside this class*/
    ...
    public void addPhoto(Photo photo) {
        ...
        String query = "INSERT INTO " + TABLE_PHOTOS + " (" +
                TABLE_ROW_TITLE + ", " + TABLE_ROW_URI + ", " +
                TABLE_ROW_LOCATION_LAT + ", " + TABLE_ROW_LOCATION_LONG + ", " +
                TABLE_ROW_TAG1 + ", " + TABLE_ROW_TAG2 + ", " +
                TABLE_ROW_TAG3 + ") VALUES (" + "'" + photo.getTitle() +
        ...
        query = "INSERT INTO " + TABLE_TAGS + "(" + TABLE_ROW_TAG + ") " +
                "SELECT '" + photo.getTag1() + "' " +
                "WHERE NOT EXISTS (SELECT 1 FROM " + TABLE_TAGS +
                " WHERE " + TABLE_ROW_TAG + " = " +
                "'" + photo.getTag1() + "');";
        ...
        query = "INSERT INTO " + TABLE_TAGS + "(" +
                ...
                TABLE_TAGS + " WHERE " + TABLE_ROW_TAG + " = " +
                "'" + photo.getTag2() + "');";
        ...
        query = "INSERT INTO " + TABLE_TAGS + "(" +
                ...
                "WHERE NOT EXISTS (SELECT 1 FROM " + TABLE_TAGS +
                " WHERE " + TABLE_ROW_TAG + " = " + "'" + photo.getTag3() + "');";
    ...
    //this class is created when our DataManager class is initialized
